...
@Service
@Qualifier("secondary")
public class CoffeeService_2Impl implements CoffeeService, SmartLifecycle {
	@Autowired
...
public CoffeeAvailability getCoffeeAvailability(String name) {
	System.out.println("Thread name for getCoffeeAvailability:   "+ Thread.currentThread().getName());
